...
![Figure 1. Traditional Schedule-Based Irrigation vs. Precision AI Irrigation](images/fig_01_traditional_schedule_based_irrigation_vs_precision_ai.png)
...
![Figure 2. Soil-Plant-Atmosphere Continuum (SPAC) Water Potential Gradient](images/fig_02_soil_plant_atmosphere_continuum_spac_water_potential.png)
...
![Figure 3. Partitioning of Total Evapotranspiration into Soil Evaporation and Canopy Transpiration](images/fig_03_partitioning_of_total_evapotranspiration_into_soil.png)
...
![Figure 4. Crop Coefficient (Kc) Curve Across Phenological Growth Stages](images/fig_04_crop_coefficient_kc_curve_across_phenological_growth_stages.png)
...
![Figure 5. Soil Moisture Zones From Saturation to Permanent Wilting Point](images/fig_05_soil_moisture_zones_from_saturation_to_permanent_wilting.png)
...
![Figure 6. Multi-Source Data Ingestion Engine](images/fig_06_multi_source_data_ingestion_engine.png)
...
![Figure 7. Multi-Depth In-Situ IoT Soil Probe Node](images/fig_07_multi_depth_in_situ_iot_soil_probe_node.png)
...
![Figure 8. Crop Water Stress Index (CWSI) Scale From No Stress to Maximum Stress](images/fig_08_crop_water_stress_index_cwsi_scale_from_no_stress_to.png)
...
![Figure 9. AI Predictive Architecture: Physics-Informed and Temporal Models](images/fig_09_ai_predictive_architecture_physics_informed_and_temporal.png)
...
![Figure 10. Physics-Informed Neural Network (PINN) Training Loop](images/fig_10_physics_informed_neural_network_pinn_training_loop.png)
...
![Figure 11. Closed-Loop Automated Irrigation Control Architecture](images/fig_11_closed_loop_automated_irrigation_control_architecture.png)
...
![Figure 12. Sample 4x4 Spatial Management-Zone VRI Prescription Map](images/fig_12_sample_4x4_spatial_management_zone_vri_prescription_map.png)
...
![Figure 13. Nebraska Center-Pivot Maize Implementation Schematic](images/fig_13_nebraska_center_pivot_maize_implementation_schematic.png)
...
![Figure 14. Mendoza Vineyard Precision Drip Irrigation Schematic](images/fig_14_mendoza_vineyard_precision_drip_irrigation_schematic.png)
...
![Figure 15. Challenges and Bottleneck Taxonomy](images/fig_15_challenges_and_bottleneck_taxonomy.png)
...
![Figure 16. Future Horizons: LEO Satellite IoT, Edge Quantum-AI, and Autonomous Robotics](images/fig_16_future_horizons_leo_satellite_iot_edge_quantum_ai_and.png)
