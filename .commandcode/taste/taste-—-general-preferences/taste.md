...
- Prefers figures to be generated programmatically from a runnable Python script (e.g., a `.py` that emits images) rather than hand-made, and expects the script to be run to produce them. Confidence: 0.55
